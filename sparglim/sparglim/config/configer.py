...
class SparkEnvConfiger:
    _basic = {
        ...
        "spark.sql.jsonGenerator.ignoreNullFields":("SPARGLIM_SQL_JSON_GEN", False),
    ...
    _k8s = {
        ...
        "spark.kubernetes.container.image": (
            "SPARGLIM_K8S_IMAGE",
            f"prodevonline/spark-executor:{SPARK_VERSION}",
        ),
        ...
        "spark.executor.memory": ("SPARGLIM_EXECUTOR_REQUEST_MEMORY", "2048m"),
